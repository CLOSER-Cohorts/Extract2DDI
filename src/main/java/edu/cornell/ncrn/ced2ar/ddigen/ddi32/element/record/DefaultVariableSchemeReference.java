...
public class DefaultVariableSchemeReference extends Reference {
	...
	public DefaultVariableSchemeReference(String id, String agency, int version) {
		super(id, agency, version, NODE_NAME_DEFAULT_VARIABLE_SCHEME_REFERENCE, ReferenceObjectType.VariableScheme);
	}
